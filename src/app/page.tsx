    ...
    <MaxWidhtWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden
                      ...
                      <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
                        Quill allows you to have a conversations with any PDF document. Simply
      ...
      <div className="mb-12 px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Chatting to your PDF file has never been easier than with Quill.
          </p>
        </div>
      </div>
        ...
        <li className="md:flex-1">
          <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
            ...
            <span className="mt-2 text-zinc-700">
              Either starting out with a free plan or choose our <Link href="/pricing" className="text-blue-700 underline-offset-2">
                pro plan.
                </Link>
            </span>
          </div>
